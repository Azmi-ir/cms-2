      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <input type="text" class="form-control @error('judul_vid') is-invalid @enderror" id="judul_vid" placeholder="Masukan nama kategori" name="judul_vid" value="{{ old('judul_vid') }}">
            @error('judul_vid')
            ...
            <input type="text" class="form-control @error('video') is invalid @enderror" id="video" placeholder="Masukan URL YouTube Video" name="video" value="{{ old('video') }}">
            @error('video')
            <div class="invalid-feedback">
                {{$message}}
            </div>
