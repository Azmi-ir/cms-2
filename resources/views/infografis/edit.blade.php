          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <form method="post" action="/infografis/{{$infografis->id}}" enctype="multipart/form-data">
            @csrf
            @method('patch')
            ...
            <div class="form-group">
              ...
              <td style="width: 85%;">
                <input type="text" class="form-control @error('judul') is invalid @enderror" id="judul" placeholder="Masukan Judul" name="judul" value="{{ $infografis->judul }}">
              </td>
            @error('judul')
            ...
            <div class="form-group">
              ...
              <td style="width: 85%;">
                <textarea type="text" class="form-control" id="deskripsi" placeholder="Masukan deskripsi" name="deskripsi" value="{{ $infografis->deskripsi }}" rows="3">{{ $infografis->deskripsi }}</textarea>
              </td>
            </div>
              </tr>
